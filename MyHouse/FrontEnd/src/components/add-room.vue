<template>
    <div class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
        <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-2xl">
            <h1 class="font-bold text-center text-2xl mb-5">Add Room {{ position }}</h1>
...
export default {
    ...
    methods: {
        async onSubmitRoom() {
            ...
            await axios.post('http://127.0.0.1:8000/api/Rooms', this.room, {
                headers: {
                ...
                .then((res) => {
                    ...
                    if(this.dashboard) {
                        this.$emit('AddRoomInfo', true,this.floors_id)
                        this.position--
                    };
                    this.room.RoomPic = '';
                    this.room.RoomType = '';
