    ...
    <div>
      ...
      <div v-if="!houses.Loading">
        ...
        <div class="m-6 display">
          <div v-for="house in houses.houses" :key="house">
...
import { houseStore } from '../stores/houseStore';
  export default {
    ...
    ,
    mounted(){
      houseStore().getHouseInfo(false,false,this.type)
    }
  }
  </script>
